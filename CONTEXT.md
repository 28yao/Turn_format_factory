...
- **实施范围**: 图片和音频转换功能完整可用，视频入口为占位状态
- **页面路由**: SPA 切换，image-settings / audio-settings / video-placeholder 三个面板互斥显示
